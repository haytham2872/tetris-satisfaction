...
const choiceOptions = {
  2: ["Oui", "Non"],
  3: ["Oui", "Non", "Excellent", "Bon", "Moyen", "Insuffisant"],
  4: ["Toujours", "Souvent", "Parfois", "Rarement"],
  5: ["Oui", "Non", "Très clair", "Clair", "Peu clair", "Pas clair du tout"],
  6: ["Oui", "Non", "très simple", "Plutôt simple", "Plutôt compliqué", "Très compliqué"],
...
export const initialQuestions = [
  ...
  { id: 3, text: "Comment évaluez-vous la rapidité de nos réponses à vos demandes ?", type: "choice", options: choiceOptions[2] },
  { id: 4, text: "Les solutions d'assurance proposées correspondent-elles à vos besoins ?", type: "choice", options: choiceOptions[4] },
  { id: 5, text: "Comment jugez-vous la clarté des informations fournies ?", type: "choice", options: choiceOptions[2] },
